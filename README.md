...
```bash
curl -O https://raw.githubusercontent.com/9holy/reinstall/main/reinstall.sh || wget -O reinstall.sh $_
```

国内服务器：

```bash
curl -O https://www.ghproxy.cc/https://raw.githubusercontent.com/9holy/reinstall/main/reinstall.sh || wget -O reinstall.sh $_
```
...
```batch
certutil -urlcache -f -split https://raw.githubusercontent.com/9holy/reinstall/main/reinstall.bat
```

国内服务器：

```batch
certutil -urlcache -f -split https://www.ghproxy.cc/https://raw.githubusercontent.com/9holy/reinstall/main/reinstall.bat
```
